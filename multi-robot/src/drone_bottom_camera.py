...
class drone_camera:
    def __init__(self, drone_N):
        ...
        rospy.init_node("drone{}_bottom_camera_vision".format(drone_N), anonymous=False)
        self.track_flag = False
        self.default_pose_flag = True

        self.bridge = cv_bridge.CvBridge()
        self.image_sub = rospy.Subscriber('/drone{}/down_cam/camera/image'.format(drone_N), Image, self.image_callback)
