        ...
        if self.motor_on():
            ...
            try:
                while 1:
                    ...
                    ### State 1 : Do proposed strategy until find a person (Strategy not implemented) 
                    ...
                    ### State 2 : Rotate until person found is in the middle of the image 
                    ...
                    ### State 3 : Drone rises 9 meters to avoid obstacles 
                    ...
                    ### State 4 : Drone moves linearly until detect a person with infrared sensor  
                    ...
                    ### State 5 : Hover over person found
